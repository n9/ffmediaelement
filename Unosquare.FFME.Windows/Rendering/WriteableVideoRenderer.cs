namespace Unosquare.FFME.Rendering
{
    ...
    internal sealed class WriteableVideoRenderer : IMediaRenderer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteableVideoRenderer"/> class.
        /// </summary>
        /// <param name="mediaEngine">The core media element.</param>
        public WriteableVideoRenderer(MediaEngine mediaEngine)
        {
        ...
        public async Task Close()
        {
            WindowsPlatform.Instance.Gui?.Invoke(DispatcherPriority.Render, () =>
            {
                ...
                MediaElement.Dispatcher.Invoke(() => { }, DispatcherPriority.Render);
            });
        ...
        public async Task Render(MediaBlock mediaBlock, TimeSpan clockPosition)
        {
            ...
            {
                MediaElement?.MediaCore?.Log(MediaLogMessageType.Debug, $"{nameof(WriteableVideoRenderer)}: Frame skipped at {mediaBlock.StartTime}");
                return;
            }
                ...
                new Action<VideoBlock, TimeSpan>((b, cP) =>
                {
                    ...
                    catch (Exception ex)
                    {
                        MediaElement?.MediaCore?.Log(
                            ...
                            $"{nameof(WriteableVideoRenderer)} {ex.GetType()}: {ex.Message}. Stack Trace:\r\n{ex.StackTrace}");
                    }
                    finally
                    {
